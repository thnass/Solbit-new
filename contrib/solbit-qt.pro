...
RESOURCES += src/qt/solbit.qrc src/qt/solbit_locale.qrc

TRANSLATIONS += src/qt/locale/solbit_bg.ts \
                src/qt/locale/solbit_de.ts \
                src/qt/locale/solbit_en.ts \
                src/qt/locale/solbit_es.ts \
                src/qt/locale/solbit_fi.ts \
                src/qt/locale/solbit_fr.ts \
                src/qt/locale/solbit_it.ts \
                src/qt/locale/solbit_ja.ts \
                src/qt/locale/solbit_pl.ts \
                src/qt/locale/solbit_pt.ts \
                src/qt/locale/solbit_ru.ts \
                src/qt/locale/solbit_sk.ts \
                src/qt/locale/solbit_sv.ts \
                src/qt/locale/solbit_vi.ts \
                src/qt/locale/solbit_zh_CN.ts \
                src/qt/locale/solbit_zh_TW.ts
