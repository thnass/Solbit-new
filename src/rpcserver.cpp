...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Solbit features */
        {"solbit", "masternode", &masternode, true, true, false},
        {"solbit", "listmasternodes", &listmasternodes, true, true, false},
        {"solbit", "getmasternodecount", &getmasternodecount, true, true, false},
        {"solbit", "masternodeconnect", &masternodeconnect, true, true, false},
        {"solbit", "masternodecurrent", &masternodecurrent, true, true, false},
        {"solbit", "masternodedebug", &masternodedebug, true, true, false},
        {"solbit", "startmasternode", &startmasternode, true, true, false},
        {"solbit", "createmasternodekey", &createmasternodekey, true, true, false},
        {"solbit", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"solbit", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"solbit", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"solbit", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"solbit", "getmasternodescores", &getmasternodescores, true, true, false},
        {"solbit", "mnsync", &mnsync, true, true, false},
        {"solbit", "spork", &spork, true, true, false},
        {"solbit", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"solbit", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use solbitd, or the -server option to solbit-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> solbit-cli " + methodname + " " + args + "\n";
}
