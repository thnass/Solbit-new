...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Solbit Core solbit-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  solbit-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded Solbit transaction") + "\n" +
                               "  solbit-tx [options] -create [commands]   " + _("Create hex-encoded Solbit transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded Solbit transaction
