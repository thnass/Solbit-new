/* src/config/solbit-config.h.  Generated from solbit-config.h.in by configure.  */
/* src/config/solbit-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef Solbit_CONFIG_H

#define Solbit_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.solbit.net"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Solbit Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Solbit Core 1.0.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "solbit"
