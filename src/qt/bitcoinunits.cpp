...
// Copyright (c) 2017-2018 The SBT Core developers
...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SBT);
   // unitlist.append(mSBT);
   // unitlist.append(uSBT);
    return unitlist;
}
...
QString BitcoinUnits::description(int unit)
{
    if (Params().NetworkID() == CBaseChainParams::MAIN) {
        ...
        case SBT:
            return QString("SBT");
        case mSBT:
            return QString("Milli-SBT (1 / 1" THIN_SP_UTF8 "000)");
        case uSBT:
            return QString("Micro-SBT (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    } else {
        switch (unit) {
        case SBT:
            return QString("TestSBTs");
        case mSBT:
            return QString("Milli-TestSBTs (1 / 1" THIN_SP_UTF8 "000)");
        case uSBT:
            return QString("Micro-TestSBTs (1 / 1" THIN_SP_UTF8 "000" THIN_SP_UTF8 "000)");
        default:
            return QString("???");
        }
    }
