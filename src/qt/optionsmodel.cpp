...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nDisplayUnit"))
        settings.setValue("nDisplayUnit", BitcoinUnits::SBT);
...
// Wallet
    ...
    if (settings.contains("nAnonymizePrjAmount"))
        SoftSetArg("-anonymizesolbitamount", settings.value("nAnonymizePrjAmount").toString().toStdString());
...
void OptionsModel::Reset()
{
    ...
    settings.clear();
    resetSettings = true; // Needed in solbit.cpp during shotdown to also remove the window positions
