...
QFontDatabase::addApplicationFont(":/fonts/solbit_font");

QString windowTitle = tr("Solbit Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Solbit address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and Solbit: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Solbit Core"), this);
    aboutAction->setStatusTip(tr("Show information about Solbit Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Solbit"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Solbit addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Solbit addresses"));
    ...
    openAction->setStatusTip(tr("Open a Solbit: URI or payment request"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Solbit Core help message to get a list with possible Solbit command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Solbit Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Solbit network", "", count));
}
...
{
    QString strTitle = tr("Solbit Core"); // default title
