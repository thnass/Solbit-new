...
/** Utility functions used by the Solbit Qt UI.
 */
namespace GUIUtil
{
...
// Render Solbit addresses in monospace font
...
// Parse "solbit:" URI into recipient object, return true on successful parsing
