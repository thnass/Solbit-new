...
public:
    ...
    // const std::vector<unsigned char>& SolbitDevKey() const { return vSolbitDevKey; }
    // const std::vector<unsigned char>& SolbitFundKey() const { return vSolbitFundKey; }
...
protected:
    ...
    // std::vector<unsigned char> vSolbitDevKey;
    // std::vector<unsigned char> vSolbitFundKey;
    // int nDevFee;
    // int nFundFee;
    int nDefaultPort;
