...
#if defined(NDEBUG)
#error "Solbit cannot be compiled without assertions."
#endif
...
/** Fees smaller than this (in usolbit) are considered zero fee (for relaying and mining)
