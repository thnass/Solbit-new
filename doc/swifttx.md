...
* WebSocket: [https://github.com/SolbitManager/insight-api-solbit#web-socket-api](https://github.com/SolbitManager/insight-api-solbit#web-socket-api)
* API: [https://github.com/SolbitManager/insight-api-solbit#swifttx-transactions](https://github.com/SolbitManager/insight-api-solbit#swifttx-transactions)
...
By default, the Solbit Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Solbit Core daemon:
