...
#   c) node1 mines 32 blocks, so now node 0 has 60001solbit, node 1 has 4250solbit, node2 has none.
#   d) node0 sends 601 solbit to node2, in two transactions (301 solbit, then 300 solbit).
