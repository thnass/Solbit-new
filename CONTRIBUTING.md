Contributing to Solbit Core
============================

The Solbit Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Solbit Core project, and is not to be
confused with overall Solbit Network Protocol consensus changes.

Whether a pull request is merged into Solbit Core rests with the project merge
...
Patches that change Solbit consensus rules are considerably more involved than
...
Where a patch set proposes to change the Solbit consensus, it must have been
...
The project leader is the release manager for each Solbit Core release.
